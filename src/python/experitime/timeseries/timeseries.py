...
from experitime.timeseries.TimeseriesModelDatV1 import TimeseriesModelDatV1
from experitime.timeseries.TimeseriesModelNwbV1 import TimeseriesModelNwbV1
import numpy as np
        ...
        with kp.TemporaryDirectory() as tmpdir:
            ...
            return Timeseries({
                ...
                'data': {
                    ...
                    'timestamps_uri': kp.store_file(timestamps_fname),
                    'timestamps_dtype': timestamps_dtype,
                    'values_uris': [kp.store_file(values_fnames[i]) for i in range(num_channels)],
